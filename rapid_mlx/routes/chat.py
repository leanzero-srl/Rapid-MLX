...
def _forced_tool_call_prefix(parser_name: str | None, function_name: str) -> str | None:
    ...
    # before being added:
    #   - ``hermes`` (rapid_mlx/tool_parsers/hermes_tool_parser.py):
...
async def _create_chat_completion_impl(
    ...
    #
    # Correctness contract (see rapid_mlx/response_cache.py): this RETURNS
    ...
    cleaned_text, reasoning_text = _finalize_content_and_reasoning(
        ...
        # ``rapid_mlx/utils/chat_template.py:127`` uses for prompt
